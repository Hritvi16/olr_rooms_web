...
class _OffersState extends State<Offers> {
  ...
  Widget build(BuildContext context) {
    return load ? Scaffold(
        key: scaffoldkey,
        endDrawer: CustomDrawer(sharedPreferences: sharedPreferences, scaffoldkey: scaffoldkey, name: "OFFER"),
              ...
              children: [
                Padding(
                  ...
                  child: constraints.maxWidth < 600 ? MenuBarM(sharedPreferences: sharedPreferences, scaffoldkey: scaffoldkey)
                      : MenuBar(sharedPreferences: sharedPreferences, name: "OFFER"),
                ),
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        Padding(
                            padding: constraints.maxWidth < 600 ? EdgeInsets.zero : EdgeInsets.symmetric(horizontal: 32),
                            child: constraints.maxWidth < 600 ? getOffersM() : getOffersW()
                        ),
                        Footer()
                      ],
                    ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: Padding(
                  padding: EdgeInsets.only(right: MySize.size5(context)),
                  child: Row(
                    children: [
                      Container(
  ...
  Future<void> getAllOffers() async {
    ...
    HotelOfferResponse hotelOfferResponse = await APIService().getAllOffers(queryParameters);
